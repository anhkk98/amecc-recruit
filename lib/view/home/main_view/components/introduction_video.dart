...
import 'package:amecc_recruit/model/business/introduce_model.dart';
...
class _IntroductionVideoState extends State<IntroductionVideo> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<IntroduceModel>>(
      future: getIntro(),
          ...
          children: snapshot.data.map((e) => Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 10,),
                Text(e.title ?? '',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
                SizedBox(height: 8,),
                Column(
                  children: e.introduceDetail.map((d) => Padding(
